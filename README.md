...
|---|---|---|
| **[Nerdbot](https://github.com/savvops/nerdbot)** | Chrome MV3 side-panel AI assistant — multi-provider (Gemini, OpenAI, Anthropic, OpenRouter, Ollama, LM Studio), BYOK privacy, page context, local RAG, custom skills | React, TypeScript, Vite, Orama |
| **[HtmlToMp4 Pro](https://htmltomp4.com)** | Desktop product + CLI that renders HTML/CSS/JS animations to MP4/WebM — deterministic frame capture, GPU-aware encoding, licensing backend | Electron, Puppeteer, FFmpeg, Cloudflare Workers/KV |
...
- [Savv Studio](https://savvstudio.com) — my web design studio
- [Vanity Hair WPG](https://vanityhairwpg.ca) — salon booking & services site
...
- **Cloud / Infra:** Cloudflare (Pages, Workers/KV, Tunnels, Zero Trust), Vercel, Docker, Linux/WSL, Tailscale
- **Media automation:** Electron, Puppeteer, FFmpeg, Chromium rendering pipelines
